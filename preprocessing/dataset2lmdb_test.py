...
def file_to_binary(file_path):
    """Chuyển đổi hình ảnh sang dữ liệu nhị phân"""
...
def create_lmdb_dataset(source_folder, lmdb_path, dataset_name, map_size):
    """Tạo tập dữ liệu LMDB"""
    # Mở file LMDB và tạo cơ sở dữ liệu
...
if __name__ == '__main__':
    ...
    yaml_path = 'E:/TLCN/Main/preprocessing/config.yaml'
    # open the yaml file
    try:
